...
const deliveries = [
  ['Carlos Perez', 'Pedido #158', 'San Miguel', 'Solicitado'],
  ['Maria Lopez', 'Pedido #159', 'Lince', 'En camino'],
  ['Luis Ramos', 'Pedido #160', 'Surco', 'Solicitado'],
  ['Ana Torres', 'Pedido #161', 'San Borja', 'Entregado']
];
        ...
        <section className="admin-dashboard">
            ...
            <section className="admin-panel active">
              ...
              <div className="table-wrap">
                <table>
                  ...
                  <tbody>
                    {inventory.map(([item, quantity], index) => (
                      <tr key={item}>
                        <td>{index + 1}. {item}</td>
                        <td>{quantity}</td>
                        <td><div className="table-actions"><button type="button">Editar</button><button type="button">Quitar</button></div></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          {tab === 'delivery' && (
            <section className="admin-panel active">
              ...
              <div className="metric-grid">
                <article><span>08</span><small>Solicitudes</small></article>
                <article><span>05</span><small>En camino</small></article>
                <article><span>18</span><small>Entregados</small></article>
              </div>
              <AdminCardList data={deliveries} actionLabel="Entregar" />
            </section>
          )}
        </section>
      </div>
